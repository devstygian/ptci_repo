...
<h2 class="mt-5">Male Candidates - Formal Walk</h2>
...
<form id="scoreForm" method="post" action="">
    <table class="table" id="candidatesTable">
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="5" class="text-center">No male candidates found.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
